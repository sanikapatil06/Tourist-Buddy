...
import 'package:tourist_buddy/screens/wishlist.dart';

class PlacesScreen extends StatefulWidget {
  final Places places;

  PlacesScreen({required this.places});
          ...
          Stack(
            children: [
              Container(
                ...
                child: Hero(
                  tag: widget.places.imageUrl,
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(30.0),
                    child: Image(
                      image: AssetImage(widget.places.imageUrl),
                      fit: BoxFit.cover,
                      height: 200.0,
                    ),
                  ),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ActivityPlaces activity = widget.places.activities[index];
                return Stack(
                  children: [
                    Container(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () => Wishlist(places: places),
                                  icon: Icon(FontAwesomeIcons.heart),
                                  iconSize: 25.0,
                                  color: Colors.black,
                                ),
